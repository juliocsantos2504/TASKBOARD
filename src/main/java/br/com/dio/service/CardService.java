...
import static br.com.dio.persistence.entity.BoardColmnKindEum.CANCEL;
import static br.com.dio.persistence.entity.BoardColmnKindEum.FINAL;
...
public class CardService {
    ...
    public void moveToNextColumn(final Long cardId, final List<BoardColumnInfoDTO> boardColumnsInfo)throws SQLException{
        try{
            ...
            if (dto.blocked()){
                var message = "O card %s esta bloqueado, e necessario desbloquear para mover".formatted(cardId);
    ...
    public void block(final Long id, final String reason, final List<BoardColumnInfoDTO>boardColumsInfo) throws SQLException{
        try{
            var dao = new CardDAO(connection);
        ...
        if (dto.blocked()){
            ...
            var currentColumn = boardColumsInfo.stream()
                    .filter(bc ->bc.id().equals(dto.columnId()))
                    .findFirst()
                    .orElseThrow(()-> new IllegalStateException("O card informado pertence a outro board"));
