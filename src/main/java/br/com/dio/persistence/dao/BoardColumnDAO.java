...
import static br.com.dio.persistence.entity.BoardColmnKindEum.findByName;
...
public class BoardColumnDAO {
    ...
    public List<BoardColumnEntity> findByBoardId(final Long BoardId) throws SQLException{
        ...
        var sql = "SELECT id, name,`order`, kind, board_id FROM BOARDS_COLUMNS WHERE board_id = ? ORDER BY `order`";
        try(var statement = connection.prepareStatement(sql)){
